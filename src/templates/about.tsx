  ...
  return (
    ...
    >
      <div className=''>
            ...
            <div className='my-12 h-full max-w-[700px] rounded-3xl border-x border-y  border-gray-500/20 bg-zinc-900/70 drop-shadow'>
              <div className='flex flex-col items-center justify-center p-3 text-left'>
                <p className='md:text-md p-3 font-mono text-xs font-semibold leading-6 tracking-tighter text-white dark:text-white sm:text-sm md:leading-9'>
                  ...
                  founded on the principle that Muay Thai, the training, and the lifestyle of a
                  healthy martial artist should be available to everyone. Whether you&apos;re a book
                  worm, a business owner, a mom, a dad, a student, or even a nerd... training like a
                  Muay Thai fighter can enhance your life in many ways. We welcome everyone into the
                  mix because Muay Thai brings people together. We want everyone to be safe,
                  confident, strong and skilled. We are all nerds for something and here we are
                  nerds for fighting.
                </p>
              </div>
            </div>
        ...
        <div className='flex w-full flex-col gap-6 space-y-12'>
