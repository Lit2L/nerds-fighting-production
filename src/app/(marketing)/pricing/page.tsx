      ...
      <div className='grid w-full items-start gap-10 rounded-lg border p-10 md:grid-cols-[1fr_200px]'>
        <div className='grid gap-6'>
          <h3 className='text-xl font-bold sm:text-2xl'>
            TigerClub Members Get:
          </h3>
          <ul className='grid gap-3 text-sm text-muted-foreground sm:grid-cols-2'>
            <li className='flex items-center'>
              <Icons.check className='mr-2 size-4' /> All Experience Levels
              Welcome
            </li>
            <li className='flex items-center'>
            ...
            <li className='flex items-center'>
              <Icons.check className='mr-2 size-4' /> Boxing Gloves & Hand Wraps
              Provided. (Loaners Available)
            </li>
            <li className='flex items-center'>
              <Icons.check className='mr-2 size-4' /> Team Support for your
              goals
            </li>
          </ul>
        </div>
