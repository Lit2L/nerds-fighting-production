...
export async function AnimatedPassButton() {
  return (
    <div className='z-10'>
      ...
      >
        <AnimatedShinyText className='inline-flex h-6 w-40 items-center justify-center text-white/50 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400 md:h-9 md:w-56'>
